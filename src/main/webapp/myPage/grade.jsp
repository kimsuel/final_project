...
.tab2   li   a{margin:0 20px;padding:0;font-size:14px;font-weight:700;border:0;background:#fff;color:#d4d4d4;line-height:30px;text-align:center;text-decoration: none;}
