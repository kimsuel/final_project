...
public class HandcodingController {
    ...
    // 다중파일업로드
    @RequestMapping(value = "/test/file_uploader_html5.do",
    ...
    public String multiplePhotoUpload(HttpServletRequest request, HttpSession session) {
        ...
        try {
            ...
            sb.append("&bNewLine=true")
              ...
              .append("&sFileURL=").append("http://localhost:8080/finalProject/resources/photoUpload/")
        .append(saveName);
        } catch (Exception e) {
            e.printStackTrace();
        }
